<div>
    <div class="flex gap-2 items-center">
        <button
            wire:click='like' {{-- cuando se de click va a buscar el metodo like en LikePost.php de livewire --}}
        >
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="{{$isLiked ? "red" : "white"}}"  {{-- si ya le dio like que se pinte rojo sino blanco --}}
